...
Files: macbook-16.glb [639.28KB] > F:\Projects - My Projects\26. apple website\apple-website\macbook-website\public\models\macbook-16-transformed.glb [629.72KB] (1%)
...
export function MacbookModel16(props) {
  ...
  useEffect(() => {
    scene.traverse((child) => {
      if (child.isMesh) {
        // Change color only if the part is NOT noChangeParts
